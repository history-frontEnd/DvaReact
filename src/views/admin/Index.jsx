...
import { Tag, Layout, Menu, Icon, Breadcrumb, Popover } from 'antd'
...
class Admin extends React.Component {
  ...
  renderMenu () {
    ...
    return <Menu mode="inline" defaultSelectedKeys={defaultKey}>{this.props.app.menus.map(menu => <Menu.Item key={menu.id}>
      {this.returnItem(menu)}
    </Menu.Item>)}</Menu>
  }
            ...
            <Menu mode="horizontal" onClick={this.clickMenu}>
              <Menu.SubMenu title={
                <div className="user-menu">
                  <div className="user-img" style={{backgroundImage: `url(${this.props.app.user.head_img})`}}></div>
                  <div className="user-info">
                    ...
                    { this.props.app.user && this.props.app.user.account_type == '1' &&
                      <div className="info-tag tag-green" color="green">服务号</div> || <div className="info-tag tag-orange">订阅号</div> }
